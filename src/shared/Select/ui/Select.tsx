...
const SelectTrigger = forwardRef<HTMLButtonElement, SelectProps>(({ className, children, ...props }, ref) => (
...
const SelectContent = forwardRef<HTMLDivElement, SelectProps>(({ className, children, position = "popper", ...props }, ref) => (
...
const SelectItem = forwardRef<HTMLDivElement, SelectProps>(({ className, children, value, ...props }, ref) => (
