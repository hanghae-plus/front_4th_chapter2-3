...
export const TableHead = forwardRef<HTMLTableHeaderCellElement, Props>(({ className, ...props }, ref) => (
  <th
    ref={ref}
...
export const TableCell = forwardRef<HTMLTableDataCellElement, Props>(({ className, ...props }, ref) => (
