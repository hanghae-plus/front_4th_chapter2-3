...
interface SelectProps extends React.TextareaHTMLAttributes<HTMLButtonElement> {
  className?: string
}
...
export const SelectItem = forwardRef<HTMLDivElement, SelectItemProps & SelectPrimitive.SelectItemProps>(
